            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">配件信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="repertory" name="repertory" class="form-control"
                                               v-model="ruleForm.repertory" readonly>
                                    </div>
        ...
        for (var i = 0; i < pjTypesOptions.length; i++) {
            if(pjTypesOptions[i].codeIndex == ruleForm.pjTypes){//下拉框value对比,如果一致就赋值汉字
                var pjTypesSelect = document.getElementById("pjTypesSelect");
                    pjTypesSelect.value = pjTypesOptions[i].id;
            }
        }
    }
