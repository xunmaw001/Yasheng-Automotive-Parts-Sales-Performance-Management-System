            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">进货信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="replenish" name="replenish" class="form-control"
                                               v-model="ruleForm.replenish" readonly>
                                    </div>
                                <div class="form-group col-md-6">
                                    <label>
                                        供应商
                                        <input id="gyTypesSelect" name="gyTypesSelect" class="form-control"
                                        // v-model="ruleForm.gyTypes" readonly
                                        >
                                    </label>
                                </div>
                                <div class="form-group col-md-6">
        ...
        for (var i = 0; i < gyTypesOptions.length; i++) {
            if(gyTypesOptions[i].id == ruleForm.gyTypes){//下拉框value对比,如果一致就赋值汉字
                var gyTypesSelect = document.getElementById("gyTypesSelect");
                    gyTypesSelect.value = gyTypesOptions[i].gysname;
            }
        }
