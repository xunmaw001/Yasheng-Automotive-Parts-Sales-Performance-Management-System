                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>客户名称</label>
                                        <input id="khname" name="khname" class="form-control"
                                               placeholder="客户名称">
                                    </div>
                                   <div class="form-group col-md-6">
                                       <label>客户性别</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("kehuxixni/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("kehuxixni/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
    ...
    function dataBind() {
        ...
        $("#khname").val(ruleForm.khname);
        $("#contact").val(ruleForm.contact);
        $("#location").val(ruleForm.location);
