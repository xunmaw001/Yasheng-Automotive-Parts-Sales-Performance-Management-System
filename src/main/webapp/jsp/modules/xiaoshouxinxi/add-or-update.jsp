            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑销售信息</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="sell" name="sell" class="form-control"
                                           onchange="sellChickValue(this)"  placeholder="出售数量">
                                </div>

                                   <div class="form-group col-md-6">
                                       <label>提供客户</label>
                                       <select id="khTypesSelect" name="khTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>负责员工</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("xiaoshouxinxi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    function initializationKhtypesSelect(){
        var khTypesSelect = document.getElementById('khTypesSelect');
            khTypesSelect.add(new Option('==请选择==',''));
            for (var i = 0; i < khTypesOptions.length; i++) {
                khTypesSelect.add(new Option(khTypesOptions[i].khname,khTypesOptions[i].id));
            }
    }
    ...
    function setSelectOption() {
        for (var i = 0; i < khTypesOptions.length; i++) {
            if(khTypesOptions[i].id == ruleForm.khTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("khTypesSelect").options[i].selected = true;
            }
        }
        for (var i = 0; i < ygTypesOptions.length; i++) {
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("xiaoshouxinxi/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
