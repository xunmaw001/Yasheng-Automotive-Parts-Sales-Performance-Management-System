                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            客户名称
                                            <input type="text" id="khnameSearch" class="form-control form-control-sm"
                                                   placeholder="请输入客户名称" aria-controls="tableId">
                                        </label>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('khname')">客户名称</th>
                                    <th onclick="sort('sexTypes')">客户性别 Search</th>
                                    <th onclick="sort('contact')">联系方式</th>
                                    <th onclick="sort('location')">联系地址</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function search() {
        ...
        if ($('#khnameSearch').val() != null && $('khnameSearch').val() != '') {
            searchForm.khname = $('#khnameSearch').val();
    ...
    function getDataList() {
        http("kehuxixni/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
                    khname: searchForm.khname,
    ...
    function setDataRow(item, number) {
        ...
        var khnameCell = document.createElement('td');
        khnameCell.innerHTML = item.khname;
        row.appendChild(khnameCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("kehuxixni/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "kehuxixni");
